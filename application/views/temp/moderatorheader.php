...
<html lang="en">
   <head>
      ...
      <title><?php if(isset($title)) echo $title." - Moderator Panel "; if(isset($site_data->site_title)) echo " - ".$site_data->site_title; ?></title>
      ...
      <div class="container-fluid top-header padd">
         <div class="col-md-2 padd">
            <a href="<?php echo base_url();?>admin">
               <div class="logo">
                  <img src="<?php echo base_url();?>assets/designs/images/<?php if(isset($settings->site_logo))echo $settings->site_logo;?>" width="100%" height="50" > 
               </div>
            </a>
         </div>
         <div class="col-md-10">
