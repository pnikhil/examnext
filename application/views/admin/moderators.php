			  ...
			  <thead>
				...
				?>
					...
					<tr>
						...
						<td>
							 <a href="<?php echo base_url();?>admin/edit_user/<?php echo $r->id;?>/moderator"><div class="btn bg-primary wnm-user">Edit</div></a>
	 
							 <?php if($r->active==1) { ?>
							 
								<a href="<?php echo base_url();?>admin/blockUser/<?php echo $r->id;?>/moderator" onclick="return confirm('Are you sure you want to block this user?')"><div class="btn bg-primary wnm-user">Block</div></a>
							 
							 <?php } else {?>
							 
								<a href="<?php echo base_url();?>admin/activateUser/<?php echo $r->id;?>/moderator" onclick="return confirm('Are you sure you want to activate this user?')"><div class="btn bg-primary wnm-user">Activate</div></a>
							 
							 <?php } ?>
							 
							<a href="<?php echo base_url();?>admin/deleteUser/<?php echo $r->id;?>/moderator"><div class="btn bg-primary wnm-user" onclick="return confirm('Are you sure you want to delete this record?')">Delete</div></a> 
