...
<div class="row">
   <div class="col-md-12">
      ...
      <form method="POST" action="<?php echo base_url();?>admin/emailSettings" id="email_settings_form" >
         <?php if(count($data)>0)
            $data=$data[0];
            ?>
		...
		<div class="col-md-6 padding-p-l">
         ...
         <div class="form-group">
            ...
            <?php 
               ...
               ?>
            <input type="password" class="form-control" id="site_url" name="smtp_pass" value="<?php echo $val;?>" placeholder="Smtp Password" >
         </div>
		 <div class="form-group">
   ...
   <div class="col-md-6 padding-p-l">
         <div class="">
            ...
            <div class="module-body">
               ...
               <div class="form-group">                    
                  <label>API Key</label>      
                  <input type="text" class="form-control" name="api_key" placeholder="API Key"  value="<?php if(isset($data->api_key))		
                     echo $data->api_key;?>" />
