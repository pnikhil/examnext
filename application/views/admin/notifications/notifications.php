      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="<?php echo base_url();?>admin/addeditNotifications/<?php echo $r->nid;?>/<?php echo cleanString($r->title);?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Edit</a>
                  <a href="<?php echo base_url();?>admin/notifications/<?php echo $r->nid;?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
               </td>
            </tr>
            <?php 
			} 
