...
<div class="col-md-12 padd">
   <div class="bradcome-menu">
      <ul>
         ...
         <li><img  src="<?php echo base_url();?>assets/designs/images/arrow.png"></li>
         <li><a href="#"> <?php if(count($data)>0) echo "Update Notification"; else echo "Add Notification";?></a></li>
      </ul>
   </div>
</div>
<div class="row">
   <div class="col-md-8">
      ...
      <form method="POST" action="<?php echo base_url();?>admin/addeditNotifications" id="notifications_form">
         ...
         <div class="form-group">
            <label for="inputEmail">Post Date</label>
            <?php 
               $val = '';
         ...
         <div class="form-group">
            <label for="inputEmail">Last Date</label>
            <?php 
               $val = '';
   		...
   		//form validation rules
              $("#notifications_form").validate({
   			...
   			messages: {
   				...
   				description: {
   					required: "Please enter description for notification."
   				},
   				post_date: {
   					required: "Please enter post date of notification."
   				},
   				last_date: {
   					required: "Please enter last date of notification."
   				}
   			},
