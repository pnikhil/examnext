...
<li><a href="#">  My Profile </a></li>
 ...
 <a id="user_change_photo" onclick="do_user_photo_div('show')" style="cursor:pointer;">change photo</a>
 </div>
 <div class="col-md-9">
 ...
 <div class="details"> 	
  ...
  <div class="details"> 
	<strong>Email</strong> : <input type="text" name="email" value="<?php echo $d->email;?>" placeholder="Email" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
  </div>
  
  <div class="details">
 <strong> Phone </strong>: <input type="text" name="phone" maxlength="11" value="<?php echo $d->phone;?>" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
