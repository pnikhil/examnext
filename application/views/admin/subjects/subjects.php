      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="<?php echo base_url();?>admin/addeditSubjects/<?php echo $r->subjectid;?>/<?php echo cleanString($r->name);?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Edit</a>
                  <a href="<?php echo base_url();?>admin/subjects/<?php echo $r->subjectid;?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
               </td>
            </tr>
            <?php } 
			} 
