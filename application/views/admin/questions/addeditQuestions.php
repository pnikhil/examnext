...
<div class="col-md-12 padd">
   <div class="bradcome-menu">
      <ul>
         ...
         <li><a href="<?php echo base_url();?>admin/questionsindex<?php if(isset($subject_id)) echo "/subject_wise/".$subject_id;?>">Questions</a></li>
         <li><img  src="<?php echo base_url();?>assets/designs/images/arrow.png"></li>
         <li><a href="#"> <?php if(count($data)>0) echo "Update Question"; else echo "Add Question";?></a></li>
      </ul>
   </div>
</div>
<div class="row">
      ...
      <form method="POST" action="<?php echo base_url();?>admin/addeditQuestions" id="questions_form">
         ...
         <div class="form-group">
            ...
            <?php 
               ...
               echo form_dropdown('subjectid', $subjects, $val,'class="form-control"').form_error('subjectid');
               ?>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label for="inputEmail">Total Answers</label>
            <?php 
               $val = '';
         ...
         <div class="form-group" id="answer5DivExp" <?php if(count($data) && $data->hint=='') echo "style='display:none;'";?>>
            <label for="inputEmail">Explanation</label>
            <?php 
               $val = set_value('ansdesc');
               	if ($this->input->post( 'ansdesc' )) {
               	$val = $this->input->post( 'ansdesc' );
               	}
               	elseif (count($data)) {
               		$val = $data->hint;
               	}
               ?>
            <textarea class="editors" id="editor7" name="ansdesc" value="<?php echo $val;?>" placeholder="Explaination"><?php echo $val;?></textarea>
			<?php echo form_error('ansdesc'); ?>
         </div>
         ...
         <div class="form-group">
            ...
            <?php 
               ...
               ?>
            <input type="text" class="form-control" id="correctanswer" name="correctanswer" value="<?php echo $val;?>" placeholder="Enter Correct Answer (For e.g.,If Answer1 is correct answer,enter 1)." >
			<?php echo form_error('correctanswer'); ?>
         </div>
         <div class="form-group">
         ...
         <button type="submit" class="btn btn-primary wnm-user"><?php if(count($data)>0) echo "Update"; else echo "Add";?></button>
      </form>
   </div>
</div>
