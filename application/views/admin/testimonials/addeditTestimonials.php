...
<div class="col-md-12 padd">
   <div class="bradcome-menu">
      <ul>
         ...
         <li><img  src="<?php echo base_url();?>assets/designs/images/arrow.png"></li>
         <li><a href="#"> <?php if(count($data)>0) echo "Update Testimonial"; else echo "Add Testimonial";?></a></li>
      </ul>
   </div>
</div>
<div class="row">
      ...
      <form method="POST" action="<?php echo base_url();?>admin/addeditTestimonials" id="testimonials_form" enctype="multipart/form-data">
		...
		<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
         ...
         <div class="form-group">
            ...
            ?>
            <input type="text" class="form-control" id="author" name="author" value="<?php echo $val;?>" placeholder="Enter Author Name of Testimonial" >
         ...
         <div class="form-group">
            ...
            ?>
            <textarea class="editors" id="editor1" name="description" 
			placeholder="Enter Description for Testimonial"><?php echo $val;?></textarea>
...
<script type="text/javascript"> 
   (function($,W,D)
   {
      ...
      JQUERY4U.UTIL =
      {
          ...
          {				
   		//Additional Methods
   		$.validator.addMethod("dateFormat",function(value, element) { return value.match(/^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](20)\d\d$/); }, "Please enter a date in the format dd-mm-yyyy (e.g., 31-06-2014).");			
   		...
   		//form validation rules
              $("#testimonials_form").validate({
   			...
   			messages: {
   				author: {
                          required: "Please enter author name for testimonial."
                      },
   				description: {
   					required: "Please enter description for testimonial."
   				},
				author_photo: {
