   ...
   <body class="emailr">
      ...
      <div class="container-fluid content-bg">
         ...
         <div class="container emailer-wi">
            <h3>Welcome To <?php if(isset($this->config->item('site_settings')->site_title)) echo $this->config->item('site_settings')->site_title;?></h3>
            <h5> <?php echo sprintf(lang('email_activate_heading'), $identity);?></h5>
            <p>Thank you for your interest for registering with DOES. It is very helpful for conducting exams and track the performance of the students</p>
